...
import { DashboardIcon, LogoutIcon, ManageIcon, MapsIcon, ProfileIcon, SettingIcon } from "../../icons";
...
export default function AdminSidebar() {
  ...
  return (
    <div className="bg-neutral-500 w-60 h-screen p-4 flex flex-col text-white">
      {/* Profile */}
